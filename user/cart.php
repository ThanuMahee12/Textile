...
if(isset($_SESSION["uname"]))
{
	...
	$sql = mysqli_query($conn,"select * from tbl_cart where username='$username'");
	...
	$sql = mysqli_query($conn,"select  * from tbl_cart");
	if(!mysqli_num_rows($sql)>0)
	{
		echo"<script>alert('No items in cart')</script>";
	}
					...
					<div class="col-sm-8">
						...
						<div class="shop-menu pull-right">
							<ul class="nav navbar-nav">
								...
								<li><a href="checkout.php"><i class="fa fa-crosshairs"></i>Check Out</a></li>
					...
					?>
						<tr>
							<td class="cart_product">
								<a href=""><img src="<?php echo $row['Item']?>" alt="" height="100" width="100"></a>
							</td>
							...
							<td class="cart_quantity">
								<div class="cart_quantity_button">
									...
									<input class="cart_quantity_input" type="text" name="quantity" value="<?php echo $row['quantity']?>" autocomplete="off" size="2" readonly>
							...
							<td class="cart_delete">
								<a class="cart_quantity_delete" href="delete.php?id1=<?php echo($row["pid"])?>" name="del"><i class="fa fa-times"></i></a>
							</td>
						</tr>
					<?php }?>
					</tbody>
...
<center>
	<a href="checkout.php">
<input type="button" value="CHECKOUT"></a><br>
</center>
