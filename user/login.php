			...
			<div class="row">
				<div class="col-lg-12 col-sm-offset-1">
					<div class="login-form"><!--login form-->
						...
						<form name="form3" action="checklogin.php" method="post">
							<input type="text" name="username3" placeholder="User name" required />
							<input type="password" name="u_pwd3" placeholder="Password" required/>
							
							<button type="submit" name="submit3" class="btn btn-default">Login</button><br>
