    		...
    		<div class="row">  	
	    			...
	    			<div class="contact-form">
				    	...
				    	<form id="main-contact-form" class="contact-form row" name="contact-form" method="post" action="sendemail.php">
				            <div class="form-group col-md-6">
				                <input type="text" name="name" id="name" class="form-control" required pattern="[A-Za-z]+" title="please enter a valid name" placeholder="Name">
				            </div>
				            <div class="form-group col-md-6">
				                <input type="email" name="email" id="email" class="form-control" required pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,3}$" title="please enter a valid email" placeholder="Email">
				            </div>
	    		...
	    		<div class="col-sm-4">
	    			<div class="contact-info">
	    				...
	    				<address>
	    					<p>UNITEL.CO</p>
							<p>No: 120/5, Wijerama (Vidya) Mawatha, Colombo 07</p>
							<p>Sri Lanka</p>
							<p>Mobile: 077-1757509</p>
							<p>Email:mkgod.sup@gmail.com</p>
	    				</address>
