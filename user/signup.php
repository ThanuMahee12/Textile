		...
		<div class="container">
			<div class="row">
					...
					<div class="signup-form"><!--sign up form-->
						...
						<form action="create_newaccount.php" method="post">
							<input type="text" name="u_name" id="us_name" placeholder="UserName" required="required" />
							<input type="email" name="email" id="em" placeholder="Email Address" required />
							<input type="password" name="password" id="pass" placeholder="Password" required />
							<button type="submit" name="btn_submit" class="btn btn-default">Signup</button>
						</form>
					</div><!--/sign up form-->
