...
<head>
 						...
 						<script type="text/javascript">
							...
							{ 
								...
								var x = document.forms["form1"] ["qty"].value;
								var q = parseInt(x);
								if(x == "")
								{
    ...
    <title>Product Details | UNITEL.CO</title>
...
<body>
	...
	<section>
		<div class="container">
            ...
            <form name="form1" id="form1" action="#" method="post" onSubmit="return validate_qty()">			
                    <div class="col-sm-7">
							<div class="product-information"><!--/product-information-->
								<img src="images/product-details/new.jpg" class="newarrival" alt="" />
								<h2> <?php echo $row["p_name"]; ?> </h2>
								<p>Web ID: <?php echo $row["p_id"]; ?></p>
								<img src="images/product-details/rating.png" alt="" />
								<span>
									<span>US $<?php echo $row["price"]; ?> </span>
									<label> <?php echo $row["p_quantity"]; ?> </label>
...
$qry = mysqli_query($link,"select * from tbl_product where p_id='$id'");
$row = mysqli_fetch_assoc($qry);
	...
	$qry1 = mysqli_query($link,"insert into tbl_cart values('$img','$qty','$total','$username','$pname','$pr','$id')");
	echo"<script>alert('Product has been added to cart')</script>";
}
else
{
	echo"<script>alert('Pleaase Login')</script>";
